...
insert into subjects (title, image, description)
values ('Базы Данны. SQL', 'test-photo-db.png',
        'Курс по SQL предлагает практическое изучение SQL с нуля, начиная с основ и заканчивая профессиональным уровнем. В рамках курса студенты получат возможность освоить основные концепции SQL.'),
       ('Верстка сайтов', 'test-photo-web.png',
        'Предлагаем уникальную возможность освоить основы создания стильных и современных веб-страниц, начиная с HTML и заканчивая CSS, открывая перед вами новые перспективы в области веб-разработки.'),
       ('БАС', 'praxisbas.png',
        'Курс по Беспилотным авиационным средствам (БАС) предназначен для всех, кто хочет погрузиться в захватывающий мир дронов и их применения в различных сферах. На протяжении курса участники изучат ключевые аспекты проектирования, эксплуатации и управления беспилотными летательными аппаратами.');
...
VALUES ('Основы SQL', 'Изучение основ SQL, создание таблиц, выполнение запросов SELECT, INSERT, UPDATE, DELETE.', 1),
       ('Оптимизация баз данных', 'Методы оптимизации баз данных, индексы, проектирование эффективных структур данных.',
        1),
       ('Работа с различными СУБД',
        'Изучение особенностей работы с различными системами управления базами данных, такими как MySQL, PostgreSQL, SQL Server.',
        1),
       ('Транзакции и безопасность', 'Понятие транзакций, обеспечение безопасности данных, управление доступом.', 1),
       ('Резервное копирование и восстановление',
        'Методы создания резервных копий, восстановление данных, обеспечение надежности баз данных.', 1),
...
<p class="lps">БПЛА открывают новые возможности для сбора данных, мониторинга и выполнения задач, которые ранее были труднодоступны или небезопасны для человека. Они становятся важным инструментом в борьбе с изменением климата, обеспечении безопасности и повышении эффективности в различных отраслях.<p>', 10),
